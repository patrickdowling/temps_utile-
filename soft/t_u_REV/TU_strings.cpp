...
#include "TU_version.h"
  ...
  extern const char * const damping[] {
   ...
   "*0.37", "*0.40", "*0.42", "*0.45", "*0.47", "*0.50", "*0.52", "*0.55", "*0.57", "*0.60",
   "*0.62", "*0.65", "*0.67", "*0.70", "*0.72", "*0.75", "*0.77", "*0.80", "*0.82", "*0.85",
   "*0.87", "*0.90", "*0.92", "*0.95", "*0.97", " - ", 
   "*1.02", "*1.05", "*1.07", "*1.10", "*1.12", "*1.15", "*1.17", "*1.20", "*1.22", "*1.25",
   "*1.27", "*1.30", "*1.32", "*1.35", "*1.37", "*1.40", "*1.42", "*1.45", "*1.47", "*1.50",
   "*1.52", "*1.55", "*1.57", "*1.60", "*1.62", "*1.65", "*1.67", "*1.70", "*1.72", "*1.75"
  };
